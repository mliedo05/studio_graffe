...
Money::Currency.find(:clp).tap do |c|
  c.instance_variable_set(:@subunit_to_unit, 1)
  c.instance_variable_set(:@decimal_mark, ",")
  c.instance_variable_set(:@thousands_separator, ".")
end
